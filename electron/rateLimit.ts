...
type RateLimitConfig = {
  ...
  windowMs: number;
  /** Custom error message to return when limit exceeded */
  message?: string;
  /** Optional key generator function (defaults to identity) */
...
export function withRateLimit<T extends any[], R>(
  ...
  return async (...args: T): Promise<R | { ok: false; reason: string }> => {
