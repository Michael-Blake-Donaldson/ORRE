...
function parseSecondsFromTimestamp(input) {
    if (!input) {
        return 0;
    }
...
async function getTranscriber() {
    ...
    cachedTranscriber = pipeline;
    return cachedTranscriber;
}
function mapWhisperResultToChunks(result) {
...
export async function transcribeVideoAudio(videoPath, sessionId) {
